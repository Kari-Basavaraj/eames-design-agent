...
import type { MessageHistory } from '../langchain/message-history.js';
...
export interface ReflectionResult {
  ...
  /** When incomplete: question to ask user before proceeding */
  proceedQuestion?: string;
  /** When incomplete: summary of what was completed */
