...
- **LangChain v1.0.0**: [Issues Board](https://linear.app/basavaraj-team/project/eames-design-agent-sdk-v100-10213d90db52)

### GitHub
- **Repository**: https://github.com/Kari-Basavaraj/eames-design-agent
- **Branches**: `main`, `sdk`, `sdk`, `webapp`
...
3. Check [Linear project](https://linear.app/basavaraj-team/project/eames-design-agent-sdk-v100-10213d90db52) for current issues
